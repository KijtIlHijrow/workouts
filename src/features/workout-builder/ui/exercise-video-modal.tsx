...
export function ExerciseVideoModal({ open, onOpenChange, exercise }: ExerciseVideoModalProps) {
  ...
  const title = exercise.nameEn || exercise.name;
  const introduction = exercise.introductionEn || exercise.introduction;
  const description = exercise.descriptionEn || exercise.description;
