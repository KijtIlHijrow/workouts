...
Workouts nasceu do desejo de oferecer uma plataforma de treino confiável, moderna e ativamente mantida, após o projeto original <WorkoutLol variant="muted" /> ter sido abandonado.

## A história

Workouts é o resultado de uma aventura impulsionada pela comunidade.
...
Workouts é open source, garantindo transparência, modularidade e escalabilidade.
