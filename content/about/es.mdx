...
Workouts nació del deseo de ofrecer una plataforma de entrenamiento confiable, moderna y activamente mantenida, después de que el proyecto original <WorkoutLol variant="muted" /> fuera abandonado.

## La historia

Workouts es el resultado de una aventura impulsada por la comunidad.
...
Workouts es de open source, garantizando transparencia, modularidad y escalabilidad.
...
**[hello@workouts.app](mailto:hello@workouts.app)**