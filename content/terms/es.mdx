# Términos de Uso – Workouts

Estos Términos de Uso ("Términos") definen las condiciones para acceder y usar los servicios proporcionados por la plataforma Workouts y rigen los derechos y obligaciones entre Workouts y sus usuarios.

_Última actualización: 3 de mayo de 2025_

## ARTÍCULO 1: Aviso Legal

El sitio web Workouts.io es publicado por **Mathias BRADICEANU**.

El sitio web está alojado por **Vercel Inc.**, 440 N Barranca Ave #4133, Covina, CA 91723, EE.UU.

## ARTÍCULO 2: Acceso a la Plataforma

Workouts permite a los usuarios:
...
Workouts recopila y almacena datos personales ingresados por los usuarios o generados automáticamente mientras usan el servicio.  
...
Todos los elementos de la plataforma Workouts (texto, imágenes, código, logo, interfaz, componentes web, etc.) están protegidos por la ley de propiedad intelectual y siguen siendo propiedad exclusiva de Workouts o sus socios.  
Cualquier reproducción, distribución o uso comercial sin consentimiento previo por escrito está estrictamente prohibido.

Las cuentas de usuario y el contenido alojado no son transferibles y están sujetos a la aprobación de Workouts.
...
En caso de violación, Workouts puede suspender o eliminar la cuenta infractora sin aviso o reembolso.

## ARTÍCULO 6: Disponibilidad y Descargo de Garantía

Workouts hace todo lo posible para proporcionar un servicio estable y seguro.  
...
Workouts no será responsable de ningún daño directo o indirecto, incluyendo pérdidas materiales o inmateriales, que surjan de:
...
Si Workouts es encontrado responsable, su responsabilidad está expresamente limitada al monto del último pago de suscripción realizado por el usuario.

## ARTÍCULO 8: Suspensión o Terminación de Cuenta

Workouts se reserva el derecho de suspender o terminar cualquier cuenta:
...
Workouts puede modificar sus servicios, características, precios o condiciones de acceso en cualquier momento.  
...
Workouts no es responsable del contenido, seguridad o rendimiento de sitios web externos.
...
Workouts no garantiza la portabilidad automatizada de datos a servicios de terceros a menos que se establezca explícitamente en una oferta dedicada.

## ARTÍCULO 12: Indemnización

Los usuarios acuerdan defender, indemnizar y eximir de responsabilidad a Workouts de cualquier reclamo, responsabilidad, pérdida, daño o gasto (incluyendo honorarios legales) que surja de:
...
Workouts no será responsable del incumplimiento de sus obligaciones en caso de fuerza mayor, incluyendo pero no limitado a: desastre natural, incendio, inundación, disturbio, guerra, pandemia, huelga, ciberataque, falla de infraestructura, o cualquier otro evento imprevisto fuera de su control.