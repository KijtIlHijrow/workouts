# Conditions Générales de Vente – Workouts

## ARTICLE 1 : Objet

Les présentes conditions régissent la fourniture des services proposés via la plateforme Workouts (en mode SaaS).  
En souscrivant à un abonnement ou en utilisant l'application Workouts, le Client accepte pleinement et sans réserve les présentes conditions générales de vente, ainsi que les Conditions Générales d’Utilisation et la Politique de Confidentialité associées.
...
- **Application** : l'application web (et mobile le cas échéant) mise à disposition par Workouts.  
- **Client** : utilisateur de la plateforme, qu’il soit à titre personnel ou professionnel.  
- **Société** : désigne Workouts, éditée par Mathias BRADICEANU.

## ARTICLE 3 : Commande et activation

La souscription se fait en ligne sur Workouts.io.  
...
Toute demande doit être adressée à [support@Workouts.io](mailto:support@Workouts.io), ou par courrier recommandé.
...
- Respecter les droits de propriété intellectuelle de Workouts  
...
Toute infraction autorise Workouts à suspendre ou supprimer le compte, sans préavis ni indemnité.

## ARTICLE 7 : Responsabilités

Workouts ne pourra être tenu responsable des interruptions de service liées à :
...
Le Client s'engage à indemniser Workouts contre toute réclamation ou dommage résultant de l'utilisation fautive, illégale ou abusive du service, y compris les frais de défense et d’expertise.

## ARTICLE 9 : Modifications contractuelles

Workouts peut modifier les présentes CGV à tout moment.  
La version applicable est celle publiée au moment de la commande ou du renouvellement.  
Le Client est invité à consulter régulièrement la dernière version disponible sur Workouts.io.

## ARTICLE 10 : Force majeure

Workouts ne pourra être tenu responsable d’un manquement à ses obligations en cas de force majeure :  
...
Les données enregistrées dans les systèmes informatiques de Workouts constituent la preuve des commandes et des paiements.  
...
- Par email : [support@Workouts.io](mailto:support@Workouts.io)  
