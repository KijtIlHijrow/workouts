# General Terms of Sale – Workouts

## ARTICLE 1: Purpose

These terms govern the provision of services offered via the Workouts platform (SaaS model).  
By subscribing to a plan or using the Workouts application, the Client fully and unconditionally agrees to these Terms of Sale, along with the Terms of Use and Privacy Policy.
...
- **Application**: the Workouts web application (and mobile app when available).  
- **Client**: the user of the platform, whether for personal or professional use.  
- **Company**: refers to Workouts, operated by Mathias BRADICEANU.

## ARTICLE 3: Ordering and Activation

Subscriptions are purchased online via Workouts.io.  
...
Any withdrawal request must be sent to [support@Workouts.io](mailto:support@Workouts.io) or by registered mail to the Company's registered address.
...
- Respect Workouts’ intellectual property rights  
...
Workouts shall not be liable for:
...
The Client agrees to indemnify and hold harmless Workouts from any claim, loss, or liability arising from misuse, unlawful use, or breach of these terms, including legal and administrative fees.

## ARTICLE 9: Changes to the Terms

Workouts reserves the right to update these Terms of Sale at any time.  
...
Workouts shall not be held liable for any failure or delay caused by events beyond its reasonable control, such as:  
...
Digital records stored by Workouts’ systems constitute valid proof of transactions and communications.  
Invoices are available at any time in the user’s account.

## ARTICLE 12: Contact – Complaints

For questions, complaints, or issues, Clients can contact Workouts:

- By email: [support@Workouts.io](mailto:support@Workouts.io)  
