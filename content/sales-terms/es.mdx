# Términos Generales de Venta – Workouts

## ARTÍCULO 1: Objeto

Estos términos rigen la prestación de servicios ofrecidos a través de la plataforma Workouts (modelo SaaS).  
Al suscribirse a un plan o usar la aplicación Workouts, el Cliente acepta completa e incondicionalmente estos Términos de Venta, junto con los Términos de Uso y la Política de Privacidad.
...
- **Aplicación**: la aplicación web de Workouts (y aplicación móvil cuando esté disponible).  
- **Cliente**: el usuario de la plataforma, ya sea para uso personal o profesional.  
- **Empresa**: se refiere a Workouts, operada por Mathias BRADICEANU.

## ARTÍCULO 3: Pedido y activación

Las suscripciones se compran en línea a través de Workouts.io.  
...
Cualquier solicitud de desistimiento debe enviarse a [support@Workouts.io](mailto:support@Workouts.io) o por correo certificado a la dirección registrada de la Empresa.
...
- Respetar los derechos de propiedad intelectual de Workouts  
...
Workouts no será responsable de:
...
El Cliente acepta indemnizar y eximir de responsabilidad a Workouts de cualquier reclamo, pérdida o responsabilidad que surja del mal uso, uso ilegal o incumplimiento de estos términos, incluyendo honorarios legales y administrativos.

## ARTÍCULO 9: Cambios en los términos

Workouts se reserva el derecho de actualizar estos Términos de Venta en cualquier momento.  
...
Workouts no será responsable de cualquier falla o retraso causado por eventos más allá de su control razonable, tales como:  
...
Los registros digitales almacenados por los sistemas de Workouts constituyen prueba válida de transacciones y comunicaciones.  
Las facturas están disponibles en cualquier momento en la cuenta del usuario.

## ARTÍCULO 12: Contacto – Quejas

Para preguntas, quejas o problemas, los Clientes pueden contactar a Workouts:

- Por email: [support@Workouts.io](mailto:support@Workouts.io)  
