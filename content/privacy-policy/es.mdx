# Política de Privacidad de Workouts

## 1. Introducción

En **Workouts**, tomamos muy en serio la privacidad de nuestros usuarios.  
...
**Información personal**: Cuando se registra, recopilamos su nombre, dirección de correo electrónico y otros detalles relacionados con su actividad en Workouts.

**Datos de uso**: Rastreamos las interacciones con las páginas de Workouts, incluyendo clics, vistas y rendimiento de enlaces.
