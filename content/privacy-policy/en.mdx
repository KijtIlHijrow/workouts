# Workouts Privacy Policy

## 1. Introduction

At **Workouts**, we take our users' privacy very seriously.  
This Privacy Policy explains how we collect, use, and protect your personal data.  
By using our services, you agree to the practices described below.

## 2. Information We Collect

**Personal Information**: When you sign up, we collect your name, email address, and other details related to your activity on Workouts.

**Usage Data**: We track interactions with Workouts pages, including clicks, views, and link performance.
