# Politique de Confidentialité Workouts

## 1. Introduction

Chez **Workouts**, nous accordons une grande importance à la confidentialité de nos utilisateurs.  
...
**Informations personnelles** : lorsque vous vous inscrivez, nous collectons votre nom, votre adresse e-mail, et d’autres informations liées à votre activité sur Workouts.

**Données d’utilisation** : nous suivons les interactions avec les pages Workouts, notamment les clics, les vues et les performances des liens.
...
Workouts utilise des cookies pour :
...
**[hello@Workouts.io](mailto:hello@Workouts.io)**
