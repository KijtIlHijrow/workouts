export default {
  leaderboard: {
    ...
    page_subtitle: "Climb to the top and become a Workouts legend",
  ...
  premium: {
    ...
    already_premium: "You're enjoying Workouts Premium",
    no_ads: "No ads",
    upgrade: "Upgrade",
    ...
    faq: {
      ...
      subtitle: "Everything you need to know about Workouts and our mission",
      items: [
        {
        ...
        {
          question: "Can I self-host Workouts?",
          answer:
    ...
    free_intro_text:
      "Workouts is a free, open-source fitness app used daily by 60,000+ users. It's built with love (not VC money ^^) and it costs us real time and money to keep it running.",
    donation_story_text:
      "At first, we were running on donations. But as you can imagine, donations weren't sufficient to cover development and running costs. So we made you a package that will help us keep the lights on and unlock a few superpowers along the way.",
    health_upgrade_text: "If Workouts helps you level up your health, please consider going Premium :D !",
    ...
    still_unsure: "Still not sure? No worries. Workouts will always remain free and open-source.",
  ...
  workout_builder: {
    ...
    quick_search_placeholder: "Search for an exercise by name...",
    quick_search_hint: "Know the exercise? Search to add it directly to your workout",
  ...
  workout_templates: {
    ...
    subtitle: "Tap to start, long-press to edit",
    empty: "No templates saved yet",
    empty_hint: "Build a workout and save it as a template for quick access",
    build_new: "Build New Workout",
