export default {
  leaderboard: {
    ...
    page_subtitle: "Grimpez au sommet et devenez une légende Workouts",
  ...
  premium: {
    ...
    already_premium: "Vous profitez de Workouts Premium",
    ...
    faq: {
      ...
      subtitle: "Tout ce que vous devez savoir sur Workouts et notre mission",
      items: [
        {
        ...
        {
          question: "Puis-je auto-héberger Workouts ?",
          answer:
      ...
      additional_support: {
        ...
        community: "Support communautaire (discord ou hello@workouts.app)",
    ...
    free_intro_text:
      "Workouts est une application de fitness gratuite et open-source utilisée quotidiennement par plus de 60 000 utilisateurs. Elle est construite avec amour (pas avec l'argent des VCs ^^) et nous coûte du temps et de l'argent réels pour la maintenir en ligne.",
    donation_story_text:
    ...
    health_upgrade_text: "Si Workouts vous aide à améliorer votre santé, pensez à passer Premium :D !",
    ...
    still_unsure: "Toujours pas sûr ? Pas de souci. Workouts restera toujours gratuit et open-source.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_19: {
        ...
        content:
          "Workouts v1.2 est maintenant une Progressive Web App ! Installez-la sur votre téléphone pour une expérience d'application native avec accès hors ligne.",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "Workouts a atteint le <strong>top spot</strong> sur Hacker News ! Merci à tous pour le support incroyable — bienvenue à tous les nouveaux utilisateurs ! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Débloquez des fonctionnalités avancées avec Workouts Premium",
    or: "ou",
  },
