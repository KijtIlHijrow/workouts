export default {
  leaderboard: {
    ...
    page_subtitle: "Suba ao topo e torne-se uma lenda do Workouts",
  ...
  premium: {
    ...
    already_premium: "Está a desfrutar do Workouts Premium",
    no_ads: "Sem anúncios",
    upgrade: "Atualizar",
    ...
    faq: {
      ...
      subtitle: "Tudo o que precisa de saber sobre Workouts e a nossa missão",
      items: [
        {
        ...
        {
          question: "Posso auto-hospedar o Workouts?",
          answer:
      ...
      additional_support: {
        ...
        community: "Suporte comunitário (discord ou hello@workouts.app)",
    ...
    free_intro_text:
      "Workouts é uma aplicação de fitness gratuita e open source usada diariamente por mais de 60.000 utilizadores. É construída com amor (não com dinheiro de VC ^^) e custa-nos tempo e dinheiro real mantê-la a funcionar.",
    donation_story_text:
      "No início, funcionávamos com doações. Mas como pode imaginar, as doações não foram suficientes para cobrir os custos de desenvolvimento e funcionamento. Então criámos um pacote que nos ajudará a manter as luzes acesas e desbloquear alguns superpoderes pelo caminho.",
    health_upgrade_text: "Se o Workouts o ajuda a melhorar a sua saúde, por favor considere tornar-se Premium :D !",
    ...
    still_unsure: "Ainda não tem certeza? Sem problemas. O Workouts permanecerá sempre gratuito e open source.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_19: {
        ...
        content:
          "O Workouts v1.2 já é uma Progressive Web App! Instale-a no seu telemóvel para uma experiência de aplicação nativa com acesso offline. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "O Workouts chegou ao primeiro lugar no Hacker News! Obrigado a todos pelo apoio incrível e bem-vindos todos os novos utilizadores! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Desbloqueie funcionalidades avançadas com Workouts Premium",
    or: "ou",
  },
