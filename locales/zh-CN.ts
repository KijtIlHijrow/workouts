export default {
  leaderboard: {
    ...
    last_workout: "上次锻炼",
    page_title: "冠军排行榜",
    page_subtitle: "登上顶峰，成为 Workouts 传奇",
  ...
  premium: {
    ...
    already_premium: "您正在享受 Workouts Premium",
    no_ads: "无广告",
    upgrade: "升级",
    ...
    faq: {
      ...
      additional_support: {
        ...
        community: "社区支持（Discord 或 hello@workouts.app）",
    ...
    free_intro_text:
      "Workouts 是一个免费、开源的健身应用，每天有 60,000+ 用户使用。它是由爱（不是 VC 资金 ^^）构建的，并且为我们保持运行需要真实的时间和金钱。",
    donation_story_text:
      "起初，我们依靠捐赠运行。但正如您所想，捐赠不足以支付开发和运行成本。所以我们为您制作了一个包，将帮助我们保持灯光，并在路上解锁一些超级能力。",
    health_upgrade_text: "如果 Workouts 帮助您提升健康，请考虑升级到高级：D ！",
    ...
    still_unsure: "还不确定？没关系。Workouts 将始终保持免费和开源。",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_19: {
        title: "📱 现已作为 PWA 提供！",
        content: "Workouts v1.2 现在是一个渐进式网络应用！将其安装在您的手机上，即可享受原生应用体验和离线访问。🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content: "Workouts 在 Hacker News 上登顶！感谢大家的大力支持，欢迎所有新用户！💪",
      },
      note_2025_06_01: {
        title: "🎉 新功能：版本说明对话框",
  ...
  donation_alert: {
    title: "使用 Workouts Premium 解锁高级功能",
    or: "或",
  },
