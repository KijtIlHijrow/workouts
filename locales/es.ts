export default {
  leaderboard: {
    ...
    page_subtitle: "Sube a la cima y conviértete en una leyenda de Workouts",
  ...
  premium: {
    ...
    already_premium: "Estás disfrutando de Workouts Premium",
    no_ads: "Sin anuncios",
    upgrade: "Actualizar",
    ...
    faq: {
      ...
      subtitle: "Todo lo que necesitas saber sobre Workouts y nuestra misión",
      items: [
        {
        ...
        {
          question: "¿Puedo auto-alojar Workouts?",
          answer:
      ...
      additional_support: {
        ...
        community: "Community support (discord or hello@workouts.app)",
    ...
    free_intro_text:
      "Workouts es una aplicación de fitness gratuita y de código abierto utilizada diariamente por más de 60,000 usuarios. Está construida con amor (no con dinero de VC ^^) y nos cuesta tiempo y dinero real mantenerla funcionando.",
    donation_story_text:
      "Al principio, funcionábamos con donaciones. Pero como puedes imaginar, las donaciones no fueron suficientes para cubrir los costos de desarrollo y funcionamiento. Así que creamos un paquete que nos ayudará a mantener las luces encendidas y desbloquear algunos superpoderes en el camino.",
    health_upgrade_text: "Si Workouts te ayuda a mejorar tu salud, por favor considera pasarte a Premium :D !",
    ...
    still_unsure: "¿Todavía no estás seguro? No te preocupes. Workouts siempre seguirá siendo gratuito y de código abierto.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_19: {
        ...
        content:
          "¡Workouts v1.2 ahora es una Progressive Web App! Instálala en tu teléfono para una experiencia de aplicación nativa con acceso sin conexión. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "¡Workouts alcanzó el primer lugar en Hacker News! ¡Gracias a todos por el increíble apoyo y bienvenidos a todos los nuevos usuarios! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Desbloquea funciones avanzadas con Workouts Premium",
    or: "o",
  },
