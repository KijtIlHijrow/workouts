export default {
  leaderboard: {
    ...
    page_subtitle: "Поднимитесь на вершину и станьте легендой Workouts",
  ...
  premium: {
    ...
    already_premium: "Вы наслаждаетесь Workouts Premium",
    no_ads: "Без рекламы",
    upgrade: "Обновить",
    ...
    faq: {
      ...
      subtitle: "Все, что вам нужно знать о Workouts и нашей миссии",
      items: [
        {
        ...
        {
          question: "Могу ли я самохостить Workouts?",
          answer:
      ...
      additional_support: {
        ...
        community: "Поддержка сообщества (дискорд или hello@workouts.app)",
    ...
    free_intro_text:
      "Workouts — это бесплатное приложение для фитнеса с открытым исходным кодом, которым ежедневно пользуются более 60 000 пользователей. Оно создано с любовью (а не на деньги венчурных фондов ^^) и требует реальных затрат времени и денег для поддержки.",
    donation_story_text:
    ...
    health_upgrade_text: "Если Workouts помогает вам улучшить здоровье, пожалуйста, рассмотрите возможность перехода на Премиум :D !",
    ...
    still_unsure: "Все еще не уверены? Не волнуйтесь. Workouts всегда останется бесплатным и с открытым исходным кодом.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_19: {
        ...
        content:
          "Workouts v1.2 теперь является прогрессивным веб-приложением! Установите его на ваш телефон для получения нативного опыта приложения с офлайн доступом. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "Workouts достиг первого места на Hacker News! Спасибо всем за потрясающую поддержку и добро пожаловать всем новым пользователям! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Разблокируйте расширенные функции с Workouts Premium",
    or: "или",
  },
